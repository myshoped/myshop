...
class OrderController extends Controller
{
    ...
    public function show($id, Request $request)
    {
        ...
        return view('admin/order_info/list', ['data' => $rs, 'data2' => $rss, 'data3' => $as,'title' => '浏览订单']);
        // dd($rs);
    ...
    public function fahuo($id)
    {
        ...
        $type = order::where('id',$id)->update(['status'=>'2']);
        return redirect("/admin/order");
    ...
    {
       $rs = DB::table('youqing')->get();
       return view('home/youqing',['rs'=>$rs]);
    }
