                ...
                <div class="row col-md-12">
                    ...
                    <div class="col-md-10 pull-right">
				        <div class="m_right" style="margin-left: 50px;">
				            ...
				            <div class="mem_t">修改密码</div>
				        <form action="/home/doupwd" method="post" enctype="multipart/form-data">
				        	{{ csrf_field() }}
				              ...
				              <tr height="45">
				                ...
				                <td>
				                    <input type="password" name="oldupwd" class="form-control" value="">
				                </td>
				              </tr>
				              <tr height="45">
				                <td align="right">新密码&nbsp; &nbsp;</td>
				                <td>
				                    <input type="password" name="upwd" class="form-control" value="">
				                </td>
				              </tr>
				              <tr height="45">
