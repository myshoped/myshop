...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form role="form" action="/admin/permission/{{$rs->id}}" method="post" class="form-horizontal">
            {{csrf_field()}}
            {{method_field('PUT')}}
            @if (count($errors) > 0)
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="pername" class="form-control" id="field-1" placeholder="请输入权限名" value="{{$rs->pername}}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="field-1">
                ...
                <div class="col-sm-10">
                    <input type="text" name="perurl" class="form-control" id="field-1" placeholder="请输入权限路径" value="{{$rs->perurl}}">
                </div>
            </div>
