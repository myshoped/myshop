...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form role="form" action="/admin/users" method="post" enctype='multipart/form-data' class="form-horizontal">
            {{csrf_field()}}
            @if (count($errors) > 0)
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="uname" class="form-control" id="field-1" placeholder="请输入账号">
                </div>
            </div>
