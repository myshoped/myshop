            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <div id="example-1_filter" class="dataTables_filter" style="float: right;">
                        <label>
                            账户:
                            <input type="text" name="uname" class="form-control input-sm" placeholder="请输入用户名" aria-controls="example-1" value="{{$request->uname}}">
                        </label>
                        <label>
                            邮箱:
            ...
            style="width: 100%;">
                <thead>
                    <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="example-1" rowspan="1"
                        colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 150px;">
                            操作
                        </th>
                    </tr>
                </thead>
