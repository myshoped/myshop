...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form role="form" action="/admin/user/{{$user->id}}" method="post" enctype='multipart/form-data' class="form-horizontal">
        	{{method_field('PUT')}}
            {{csrf_field()}}
            @if (count($errors) > 0)
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="uname" class="form-control" id="field-1" value="{{$user->uname}}" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="field-1">
                ...
                <div class="col-sm-10">
                    <input type="text" name="age" class="form-control" id="field-1" value="{{$user->age}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="radio">
                        <label>
                            <input type="radio" name="sex" value="w" @if($user->sex == 'w') checked @endif>
                            女
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="sex" value="x" @if($user->sex == 'x') checked @endif>
                            保密
                        </label>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="phone" class="form-control" id="field-2" placeholder="请输入手机号" value="{{$user->phone}}">
                </div>
            </div>
            <div class="form-group-separator"></div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="email" name="email" class="form-control" id="field-2" placeholder="请输入邮箱" value="{{$user->email}}">
                </div>
            </div>
            <div class="form-group-separator"></div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="test" name="addr" class="form-control" id="field-2" placeholder="请输入地址" value="{{$user->addr}}">
                </div>
            </div>
            <div class="form-group-separator"></div>
            <div class="form-group">
